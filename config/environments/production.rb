WebsiteOne::Application.configure do
  ...
  config.assets.precompile += %w( projects.js users.js bootstrap-datepicker.js bootstrap-tokenfield.min.js bootstrap-tags.js bootstrap-timepicker.min.js event_datepicker.js events.js)
