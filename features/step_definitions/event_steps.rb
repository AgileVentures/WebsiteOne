...
When(/^the HangoutConnection has pinged to indicate the event start, then the youtube link will not be sent$/) do
  yt_tweet = "Alejandro just hosted an online #scrum Missed it? Catch the recording at youtu.be/11 #CodeForGood #opensource"
  hangout_tweet = "#Scrum meeting with our #distributedteam is live on http://hangout.test Join in and learn about our #opensource #projects!"
  allow(TwitterService.twitter_client).to receive(:update).with(hangout_tweet)
  expect(TwitterService.twitter_client).not_to receive(:update).with(yt_tweet)
...
When(/^the HangoutConnection has pinged to indicate the event start, then the hangout link will be sent$/) do
  yt_tweet = "Alejandro just hosted an online #scrum Missed it? Catch the recording at youtu.be/11 #CodeForGood #opensource"
  hangout_tweet = "#Scrum meeting with our #distributedteam is live on http://hangout.test Join in and learn about our #opensource #projects!"
  expect(TwitterService.twitter_client).to receive(:update).with(hangout_tweet)
  #expect(TwitterService.twitter_client).not_to receive(:update).with(yt_tweet)
