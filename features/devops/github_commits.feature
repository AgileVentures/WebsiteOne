Feature: Update github stats of all projects
   ...
   Scenario: Update github commit count of all projects with valid github_url
      ...
      | title        | description         | github_url                                    | status   | commit_count |
      | Auotgrader   | awesome autograder  | https://github.com/AgileVentures/WebsiteTwo   | active   | 2            |
      | WebsiteOne   | website one project | https://github.com/AgileVentures/WebsiteOne   | inactive | 2            |
      | LocalSupport | Scheduler queue     | https://github.com/AgileVentures/LocalSupport | active   | 2            |
      | Unity        | Unity project       |                                               | active   | 1            |
