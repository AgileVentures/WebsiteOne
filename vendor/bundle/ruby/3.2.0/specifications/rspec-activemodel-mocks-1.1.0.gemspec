# -*- encoding: utf-8 -*-
# stub: rspec-activemodel-mocks 1.1.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.homepage = "https://github.com/rspec/rspec-activemodel-mocks".freeze
  s.licenses = ["MIT".freeze]
  s.rdoc_options = ["--charset=UTF-8".freeze]
  s.rubygems_version = "3.4.6".freeze
  s.summary = "rspec-activemodel-mocks-1.1.0".freeze
  ...
  s.add_runtime_dependency(%q<rspec-mocks>.freeze, [">= 2.99", "< 4.0"])
