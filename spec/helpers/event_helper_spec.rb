...
describe EventHelper do
  ...
  describe 'time ranges' do
    ...
    it 'returns a local time range' do
      expected_result = \
        'Starts at <time datetime="2016-02-09T19:00:00Z" data-local="time"'\
        ' data-format="%H:%M">19:00</time> - Ends at '\
        '<time datetime="2016-02-09T19:15:00Z" data-local="time"'\
        ' data-format="%H:%M">19:15</time> '\
        '<time datetime="2016-02-09T19:00:00Z" data-local="time"'\
        ' data-format="(%Z)">(UTC)</time>'
