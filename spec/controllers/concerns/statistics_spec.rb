...
describe 'StatisticsConcern' do
  ...
  describe "gets stats for projects" do
    it "and only counts active projects " do
      FactoryBot.create_list(:project, 5, status: 'active')
      FactoryBot.create_list(:project, 3, status: 'disactivated')
