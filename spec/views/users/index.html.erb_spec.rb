...
describe "users/index.html.erb" do
  before :each do
    @users = [mock_model(User, :display_name => 'Bill Black', id: 1, :first_name => 'Bill', :last_name => 'Black', :email => 'bb123@somemail.com', country?: true),
              mock_model(User, :display_name => 'Charles Cyan', id: 2, :first_name => 'Charles', :last_name => 'Cyan', :email => 'cos@somemail.com', country?: true),
              mock_model(User, :display_name => 'Dave Devlish', id: 3, :first_name => 'Dave', :last_name => 'Devlish', :email => 'dave@me.com', country?: true),
              mock_model(User, :display_name => 'Eric Ectost', id: 4, :first_name => 'Eric', :last_name => 'Ectost', :email => 'eric@somemail.se', country?: true)]
  end
